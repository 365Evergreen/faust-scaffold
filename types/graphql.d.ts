...
export type Category = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & WithAcfFeatures & {
  __typename?: 'Category';
  ...
  /** Fields of the Features ACF Field Group */
...
export type Comment = DatabaseIdentifier & Node & UniformResourceIdentifiable & WithAcfFeatures & {
  __typename?: 'Comment';
...
export type DefaultTemplate = ContentTemplate & WithAcfFeatures & {
...
/** The &quot;Features&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type Features = AcfFieldGroup & AcfFieldGroupFields & Features_Fields & {
  __typename?: 'Features';
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;Features&quot; Field Group */
...
/** Interface representing fields of the ACF &quot;Features&quot; Field Group */
export type Features_Fields = {
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;Features&quot; Field Group */
  featureName?: Maybe<Scalars['String']['output']>;
  /**
   * The name of the field group
...
export type MediaItem = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & Node & NodeWithAuthor & NodeWithComments & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & WithAcfFeatures & {
...
export type Menu = DatabaseIdentifier & Node & WithAcfFeatures & {
  __typename?: 'Menu';
...
export type MenuItem = DatabaseIdentifier & Node & WithAcfFeatures & {
  __typename?: 'MenuItem';
...
export type MenuItemObjectUnion = Category | Page | Post | Service | Tag | Tutorial;
...
export type Page = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfFeatures & {
  __typename?: 'Page';
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<HierarchicalContentNodeToContentNodeAncestorsConnection>;
  /** Connection between the NodeWithAuthor type and the User type */
...
export type Post = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & NodeWithTrackbacks & Previewable & UniformResourceIdentifiable & WithAcfFeatures & {
  __typename?: 'Post';
  /**
...
export type PostFormat = DatabaseIdentifier & Node & TermNode & UniformResourceIdentifiable & WithAcfFeatures & {
...
export type RootQuery = {
  ...
  /** A test field for the Test Experiment. */
  testExperiment?: Maybe<Scalars['String']['output']>;
  /** A test field that demonstrates optional dependencies. Returns enhanced data if TestExperiment is active, basic data otherwise. */
  testOptionalDependency?: Maybe<Scalars['String']['output']>;
  /** A Theme object */
  theme?: Maybe<Theme>;
...
export type RootQueryTutorialByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
  tutorialId?: InputMaybe<Scalars['Int']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
};
...
/** Pagination metadata specific to &quot;RootQueryToTutorialConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToTutorialConnection Nodes. */
...
/** The service type */
export type Service = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfFeatures & {
  __typename?: 'Service';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the service object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
...
export type Tag = DatabaseIdentifier & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & WithAcfFeatures & {
  __typename?: 'Tag';
  /** @deprecated Deprecated in favor of using Next.js pages */
  conditionalTags?: Maybe<ConditionalTags>;
...
/** The template assigned to the node */
export type Template_365EvergreenArchivePage = ContentTemplate & WithAcfFeatures & {
  __typename?: 'Template_365EvergreenArchivePage';
  /** Fields of the Features ACF Field Group */
  features?: Maybe<Features>;
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
...
/** The template assigned to the node */
export type Template_365EvergreenLanding = ContentTemplate & WithAcfFeatures & {
  __typename?: 'Template_365EvergreenLanding';
  /** Fields of the Features ACF Field Group */
  features?: Maybe<Features>;
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
...
/** The template assigned to the node */
export type Template_SinglePage = ContentTemplate & WithAcfFeatures & {
  __typename?: 'Template_SinglePage';
  /** Fields of the Features ACF Field Group */
  features?: Maybe<Features>;
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
...
/** The template assigned to the node */
export type Template_SinglePost = ContentTemplate & WithAcfFeatures & {
  __typename?: 'Template_SinglePost';
  /** Fields of the Features ACF Field Group */
  features?: Maybe<Features>;
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
...
/** The template assigned to the node */
export type Template_Tutorial = ContentTemplate & WithAcfFeatures & {
  __typename?: 'Template_Tutorial';
  /** Fields of the Features ACF Field Group */
  features?: Maybe<Features>;
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
...
/** The tutorial type */
export type Tutorial = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfFeatures & {
  __typename?: 'Tutorial';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<TutorialToTutorialConnection>;
  /** @deprecated Deprecated in favor of using Next.js pages */
  conditionalTags?: Maybe<ConditionalTags>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the tutorial object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the tutorial object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
   ...
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<TutorialToParentConnectionEdge>;
  /** The password for the tutorial object. */
  password?: Maybe<Scalars['String']['output']>;
...
/** The tutorial type */
export type TutorialAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** A paginated collection of tutorial Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of tutorial Nodes */
...
/** Represents a connection to a tutorial. Contains both the tutorial Node and metadata about the relationship. */
...
/** Pagination metadata specific to &quot;TutorialConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;TutorialConnectionEdge&quot; Nodes. */
...
/** Identifier types for retrieving a specific Tutorial. Specifies which unique attribute is used to find an exact Tutorial. */
...
/** Connection between the tutorial type and the tutorial type */
export type TutorialToParentConnectionEdge = Edge & OneToOneConnection & TutorialConnectionEdge & {
  __typename?: 'TutorialToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the tutorial type and the tutorial type */
export type TutorialToTutorialConnection = Connection & TutorialConnection & {
  __typename?: 'TutorialToTutorialConnection';
  /** Edges for the TutorialToTutorialConnection connection */
  edges: Array<TutorialToTutorialConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Tutorial>;
  /** Information about pagination in a connection. */
  pageInfo: TutorialToTutorialConnectionPageInfo;
};

/** An edge in a connection */
export type TutorialToTutorialConnectionEdge = Edge & TutorialConnectionEdge & {
  __typename?: 'TutorialToTutorialConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Pagination metadata specific to &quot;TutorialToTutorialConnection&quot; collections. Provides cursors and flags for navigating through sets of TutorialToTutorialConnection Nodes. */
export type TutorialToTutorialConnectionPageInfo = PageInfo & TutorialConnectionPageInfo & WpPageInfo & {
  __typename?: 'TutorialToTutorialConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
export type User = Commenter & DatabaseIdentifier & Node & UniformResourceIdentifiable & WithAcfFeatures & {
  __typename?: 'User';
  /** Avatar object for user. The avatar object can be retrieved in different sizes by specifying the size argument. */
  avatar?: Maybe<Avatar>;
...
export enum UserRoleEnum {
  ...
  /** User role with specific capabilities */
  WpConnectrPowerAutomateService = 'WP_CONNECTR_POWER_AUTOMATE_SERVICE'
}
...
/** Provides access to fields of the &quot;Features&quot; ACF Field Group via the &quot;features&quot; field */
export type WithAcfFeatures = {
  /** Fields of the Features ACF Field Group */
  features?: Maybe<Features>;
};
...
export type ExampleQueryQuery = { __typename?: 'RootQuery', posts?: { __typename?: 'RootQueryToPostConnection', nodes: Array<{ __typename?: 'Post', id: string, title?: string | null, slug?: string | null }> } | null };
